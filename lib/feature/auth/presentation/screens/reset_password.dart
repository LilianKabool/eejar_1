...
import 'package:eejar/feature/auth/presentation/screens/resend_otp.dart';
    ...
    return Form(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          //centerTitle: true,
          leading: IconButton(
            onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>ResendOtpScreen()));},
            icon: Icon(
              Icons.chevron_left,
              color: AppColors.semiDarkGolden,
            ),
              ...
              children: [
                ...
                BlocConsumer<ResetPasswordCubit, ResetPasswordState>(
                  listener: (context, state) {
                    state.whenOrNull(
                      success: (ResetPasswordEntity result) {
