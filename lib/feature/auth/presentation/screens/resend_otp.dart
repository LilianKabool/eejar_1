...
import 'package:eejar/feature/auth/presentation/screens/reset_password.dart';
import 'package:eejar/feature/auth/presentation/screens/verify_found_account.dart';
          ...
          leading: IconButton(
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => FoundAccountScreen()));
            },
            icon: Icon(
              Icons.chevron_left,
              color: AppColors.semiDarkGolden,
            ...
            children: [
              ...
              BlocConsumer<ResendOtpCubit, ResendOtpState>(
                  listener: (context, state) {
                    state.whenOrNull(
                      success: (ResendOtpEntity result) {
                        ...
                        return showAlertDialog(context, result.message);
                      },
                      error: (error) {
