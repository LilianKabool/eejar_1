...
import '../../../../feature/auth/entity/forget_password/forget_password_entity.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              BlocConsumer<ForgetPasswordCubit, ForgetPasswordState>(
                ...
                state.whenOrNull(
                  success: (ForgetPasswordEntity result) {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => FoundAccountScreen(),
                        ));
                    return showAlertDialog(context, result.message.toString());
                  },
                  error: (error) {
                      ...
                      onTap: () {
                        if (formKey.currentState!.validate()) {
                          var result = context
                              ...
                              .emitForgetPassword(
                                  email: emailForForgetPassword.text);
                          return result;
                        }
                        return null;
                      },
