...
mixin _$ResetPasswordState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ResetPasswordEntity data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ResetPasswordEntity data)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({ResetPasswordEntity data});
}
...
abstract class Success<T> implements ResetPasswordState<T> {
  const factory Success(final ResetPasswordEntity data) = _$SuccessImpl<T>;

  ResetPasswordEntity get data;
  @JsonKey(ignore: true)
  _$$SuccessImplCopyWith<T, _$SuccessImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
