...
import 'package:eejar/feature/user/entity/get_full_country_entity.dart';
...
import '../../../user/entity/profile_entity.dart';
import '../../../user/presentation/manager/get_profile_cubit.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          SpaceItem(),
          Text(
            baseProfileEntity.profile.firstName +
                baseProfileEntity.profile.lastName,
            style: TextStyle(
